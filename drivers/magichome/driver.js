  ...
  async onPairListDevices () {
    ...
    await discovery.scan(3000).then(result => {
      ...
      for (let i in discovery.clients.filter((v,i,a)=>a.findIndex(t=>(t.id === v.id))===i)) {
        ...
        } else if (result[i].model == 'HF-LPB100' || result[i].model == 'HF-LPB100-ZJ002' || result[i].model == 'HF-LPB100-ZJ200' || result[i].model == 'AK001-ZJ2104' || result[i].model == 'AK001-ZJ2145') {
