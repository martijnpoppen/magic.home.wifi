exports.typeCapabilityMap = {
    ...
    'AK001-ZJ200'     : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
    ...
    'HF-LPB100'       : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
    'HF-LPB100-0'     : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
    'HF-LPB100-1'     : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
    'HF-LPB100-ZJ002' : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
    'HF-LPB100-ZJ200' : [ 'onoff', 'dim', 'light_hue', 'light_saturation', 'addressable' ],
